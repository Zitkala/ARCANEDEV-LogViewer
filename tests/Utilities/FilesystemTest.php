...
use Zitkala\LogViewer\Utilities\Filesystem;
...
class FilesystemTest extends TestCase
{
    ...
    /** @var  \Zitkala\LogViewer\Utilities\Filesystem */
    private $filesystem;
    ...
    {
        $this->expectException(\Zitkala\LogViewer\Exceptions\FilesystemException::class);
